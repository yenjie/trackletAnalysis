...
'file:PYTHIA-new/pythia8-GEN-SIM-RAW-RECO-new_11.root',
'file:PYTHIA-new/pythia8-GEN-SIM-RAW-RECO-new_13.root',
'file:PYTHIA-new/pythia8-GEN-SIM-RAW-RECO-new_7.root',
'file:PYTHIA-new/pythia8-GEN-SIM-RAW-RECO-new_9.root',    
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('PixelTree-PYTHIA8-test.root')
                                   )
