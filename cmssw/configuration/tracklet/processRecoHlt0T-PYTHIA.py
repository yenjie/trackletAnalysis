...
#'file:step3_100k.root'
'file:step3_100k_lineTracking.root'
...
process.ana = cms.EDAnalyzer('PixelHitAnalyzer',
                             vertexSrc = cms.vstring('lineTracking'),
                             trackSrc = cms.untracked.InputTag('lineTracking'),
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('PixelTree-PYTHIA8.root')
                                   )
