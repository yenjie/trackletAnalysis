...
int pAdNdetaVsCMSE() {
    Bool_t bDrawCuLa        = kTRUE; // draw curve labels?
    Bool_t bDrawNPart       = kTRUE;  // divide by NPart instead of 0.5NPart
    ...
    TH2D *frame = new TH2D("frame","",1,10.0,20000.0,240,0.0,12.0);
    frame->SetStats(0);
    ...
    if (bDrawNPart) {
        ...
        TGaxis * gaX = new TGaxis(10.0,0.0,20000.0,0.0,10.0,20000.0,506,"G");
        ...
        TGaxis * gaXT = new TGaxis(10.0,12.0,20000.0,12.0,10.0,20000.0,506,"G-U");
        gaXT->Draw();

        TGaxis * gaY = new TGaxis(10.0,0.0,10.0,12.0,0.0,6.0,506);
    ...
    ******************************************************/
    ...
    Graph_pp_UA1->SetMarkerColor(30);
    ...
    Graph_pp_UA5->SetMarkerColor(30);
    ...
    Graph_pp_CDF->SetMarkerSize(1.0);
    Graph_pp_CDF->SetMarkerColor(30);
    ...
    Graph_pp_CMS->SetMarkerColor(30);
    ...
    Graph_pp_ALICE->SetMarkerColor(30);
    ...
    Graph_pp_STAR->SetMarkerColor(30);
    ...
    fit_pp_nsd->SetLineColor(30);
    fit_pp_nsd->SetLineStyle(9);
    ...
    TLatex* tex = new TLatex(2500,5.2,"#propto #font[52]{s}_{_{NN}}^{0.11}");
    tex->SetTextFont(43);
    tex->SetTextSize(15);
    tex->Draw();
    ...
    ******************************************************/
    ...
    Graph_AA_NA50->SetMarkerColor(46);
    ...
    Graph_AA_BRAHMS->SetMarkerColor(46);
    Graph_AA_BRAHMS->SetMarkerStyle(22);
    ...
    Graph_AA_PHENIX->SetMarkerColor(46);
    ...
    Graph_AA_PHOBOS->SetMarkerColor(46);
    ...
    Graph_AA_STAR->SetMarkerColor(46);
    ...
    Graph_AA_ALICE->SetMarkerColor(46);
    ...
    // 2-4%          8.4 +/- 0.4
    // 4-6%          8.2 +/- 0.4
    Double_t v_AA_276_ATLAS = (8.8+8.4+8.2)/3.0;
    Double_t e_AA_276_ATLAS = 0.4 / TMath::Sqrt(3.0);
    TGraphErrors * Graph_AA_276_ATLAS = new TGraphErrors(1);
    Graph_AA_276_ATLAS->SetName("Graph_AA_276_ATLAS");
    Graph_AA_276_ATLAS->SetMarkerStyle(20);
    Graph_AA_276_ATLAS->SetMarkerSize(1.0);
    Graph_AA_276_ATLAS->SetMarkerColor(46);
    Graph_AA_276_ATLAS->SetPoint(0,2760.0*1.1,v_AA_276_ATLAS);
    Graph_AA_276_ATLAS->SetPointError(0,0.0,e_AA_276_ATLAS);
    Graph_AA_276_ATLAS->Draw("E1P");
    ...
    // -0.5-0.0	8.47 +/- 0.29
    //  0.0-0.5	8.45 +/- 0.29
    Double_t v_AA_276_CMS = (8.47+8.45)/2.0;
    Double_t e_AA_276_CMS = 0.29 / TMath::Sqrt(2.0);
    TGraphErrors * Graph_AA_276_CMS = new TGraphErrors(1);
    Graph_AA_276_CMS->SetName("Graph_AA_276_CMS");
    Graph_AA_276_CMS->SetMarkerStyle(21);
    Graph_AA_276_CMS->SetMarkerSize(1.0);
    Graph_AA_276_CMS->SetMarkerColor(46);
    Graph_AA_276_CMS->SetPoint(0,2760.0,v_AA_276_CMS);
    Graph_AA_276_CMS->SetPointError(0,0.0,e_AA_276_CMS);
    Graph_AA_276_CMS->Draw("E1P");
    ...
    leg_AA->AddEntry(Graph_AA_276_CMS,"CMS","P");
    leg_AA->AddEntry(Graph_AA_ALICE,"ALICE","P");
    leg_AA->AddEntry(Graph_AA_276_ATLAS,"ATLAS","P");
    ...
    fit_AA->SetLineColor(46);
    fit_AA->SetLineStyle(9);
    ...
    tex = new TLatex(2500,10.2,"#propto #font[52]{s}_{_{NN}}^{0.15}");
    tex->SetTextFont(43);
    tex->SetTextSize(15);
    tex->Draw();
    ...
    ******************************************************/
    ...
    Graph_pA_CMS->SetMarkerColor(38);
    ...
    Graph_pA_ALICE->SetMarkerColor(38);
    ...
    Graph_dAu_PHOBOS->SetMarkerColor(38);
    ...
    Graph_pA_NA35->SetMarkerStyle(34);
    Graph_pA_NA35->SetMarkerSize(1.1);
    Graph_pA_NA35->SetMarkerColor(38);
    Graph_pA_NA35->SetPoint(0,19.4,v_pA_NA35);
    Graph_pA_NA35->SetPointError(0,0.0,e_pA_NA35);
    Graph_pA_NA35->Draw("E1P");

    TLegend *leg_pA = new TLegend(0.49,0.72,0.64,0.92,NULL,"brNDC");
    ...
    leg_pA->AddEntry(Graph_pA_NA35,"pAu NA35","P");
    leg_pA->Draw();
    ...
    Graph_pA_FNAL_360->SetMarkerColor(38);
    ...
    ******************************************************/
    ...
    Graph_pp_INEL_CMS->SetMarkerStyle(25);
    Graph_pp_INEL_CMS->SetMarkerSize(1.0);
    Graph_pp_INEL_CMS->SetMarkerColor(42);
    ...
    Graph_pp_INEL_ISR->SetMarkerStyle(24);
    Graph_pp_INEL_ISR->SetMarkerSize(1.0);
    Graph_pp_INEL_ISR->SetMarkerColor(42);
    ...
    Graph_pp_INEL_UA5->SetMarkerStyle(32);
    Graph_pp_INEL_UA5->SetMarkerSize(1.0);
    Graph_pp_INEL_UA5->SetMarkerColor(42);
    ...
    Graph_pp_INEL_PHOBOS->SetMarkerStyle(27);
    Graph_pp_INEL_PHOBOS->SetMarkerSize(1.2);
    Graph_pp_INEL_PHOBOS->SetMarkerColor(42);
    ...
    Graph_pp_INEL_ALICE->SetMarkerStyle(26);
    Graph_pp_INEL_ALICE->SetMarkerSize(1.0);
    Graph_pp_INEL_ALICE->SetMarkerColor(42);
    ...
    Graph_pp_INEL_ALICE->SetPoint(1,13000,5.31);
    Graph_pp_INEL_ALICE->SetPointError(1,0,0,0.18,0.18);
    Graph_pp_INEL_ALICE->Draw("E1P");

    // ALICE INEL>0 selection
    // TGraphAsymmErrors *Graph_pp_INEL_ALICEGT0 = new TGraphAsymmErrors(3);
    // Graph_pp_INEL_ALICEGT0->SetName("Graph_pp_INEL_ALICEGT0");
    // Graph_pp_INEL_ALICEGT0->SetMarkerStyle(29);
    // Graph_pp_INEL_ALICEGT0->SetMarkerSize(1.4
    // Graph_pp_INEL_ALICEGT0->SetPoint(0,900,3.819528);
    // Graph_pp_INEL_ALICEGT0->SetPointError(0,0,0,0.06657218,0.07340104);
    // Graph_pp_INEL_ALICEGT0->SetPoint(1,2360,4.705494);
    // Graph_pp_INEL_ALICEGT0->SetPointError(1,0,0,0.08016186,0.105886);
    // Graph_pp_INEL_ALICEGT0->SetPoint(2,7000,6.019699);
    // Graph_pp_INEL_ALICEGT0->SetPointError(2,0,0,0.1169849,0.2041839);
    // Graph_pp_INEL_ALICEGT0->Draw("E1P");
    ...
    tex = new TLatex(2500,3.25,"#propto #font[52]{s}_{_{NN}}^{0.10}");
    tex->SetTextFont(43);
    tex->SetTextSize(15);
    tex->Draw();
    ...
    c->SaveAs("figs/dNdeta_vs_CMSE.pdf");
    c->SaveAs("figs/dNdeta_vs_CMSE.png");
